    ...
    <div className="w-full max-w-4xl">
      ...
      {characters.length === 0 ? (
        <div className="rounded-xl bg-white/10 p-8 text-center">
          ...
          <h3 className="text-xl font-semibold mb-2">No EVE Characters Linked</h3>
          <p className="text-gray-300 mb-4">
            Link your EVE Online characters to start managing your corporation data.
          </p>
          <button
            onClick={handleLinkCharacter}
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-400">
                  ...
                  <span>Linked {new Date(character.createdAt).toLocaleDateString()}</span>
                </div>
              </div>
            </div>
          ))}
